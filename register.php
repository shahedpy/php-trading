				...
				<div class="form-container">
					<div>
						...
						<form action="api/registration.php" method="post">
							...
							<div class="form-group">
								<input class="form-control" name="phone" id="phone" placeholder="PHONE" type="number" maxlength="11" required>
							</div>
							<div class="form-group">
								<input class="form-control" name="nid" id="nid" placeholder="NID" type="number" maxlength="17" required>
							</div>
							<div class="form-group">
								<input class="form-control" name="refferal" id="refferal" placeholder="REFFERAL" type="text" required>
							</div>
							<div class="form-group">
								<input class="form-control" name="password" id="password" placeholder="PASSWORD" type="password" required>
							</div>
							<div class="form-group">
								<input class="form-control" name="confirm_password" id="confirm_password" placeholder="CONFIRM PASSWORD" type="password" required>
							</div>
							<div class="form-group">
